package fun.jiucai.cloud.model;
...
public enum CodeEnum {
     ...
     * 自定义错误
     */
    GROUP_NOT_EXIST(700, "聊天频道不存在"),
    CHAT_MESSAGE_IS_EMPTY(701, "聊天内容为空"),

    /**
     * 1000-1100为登录相关
     */
    SIGN_IN_WECHAT_QR_CODE_ERROR(1000, "无法获取微信验证码"),
    SIGN_IN_FAIL(1001, "账号密码错误"),
    SIGN_IN_FIRST(1002, "请先登录"),
    SIGN_IN_PHONE_NUMBER_ERROR(1003, "手机号码错误"),
